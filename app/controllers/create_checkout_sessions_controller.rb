class CreateCheckoutSessionsController < ApplicationController
  ...
  def create
    ...
    shipping = [{label: 'Tuesday Market (Monterey)', value: 'tuesday'}, {label: 'Wednesday at Cruise Coffee (Scotts Valley)', value: 'scotts valley'}, {label: 'Thursday Market (Carmel by the Sea)', value: 'thursday'}, ]
    if mode == 'payment'
