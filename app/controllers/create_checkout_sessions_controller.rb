class CreateCheckoutSessionsController < ApplicationController
  ...
  def create
    ...
    shipping = [{label: 'Tuesday Market (Monterey)', value: 'tuesday'},{label: 'Wednesday Market (Santa Cruz)', value: 'wednesday'}, {label: 'Thursday Market (Carmel by the Sea)', value: 'thursday'}, ]
    if mode == 'payment'
