class CreateCheckoutSessionsController < ApplicationController
  ...
  def create
    ...
    shipping = [{label: 'Tuesday Market (Monterey)', value: 'tuesday'}, {label: 'Wednesday at Cruise Coffee (Scotts Valley)', value: 'scottsvalley'}, {label: 'Thursday Market (Carmel by the Sea)', value: 'thursday'}, ]
    if mode == 'payment'
  ...
  def pay_invoice(invoice)
    ...
    create_payment_method(invoice.payment_intent, customer_order) unless customer_order.payment_method.present?
