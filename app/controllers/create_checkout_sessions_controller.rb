class CreateCheckoutSessionsController < ApplicationController
  ...
  def create
    ...
    shipping = [ {label: 'Tuesday Market (Monterey)', value: 'tuesday'},{label: 'Wednesday Market (Santa Cruz)', value: 'wednesday'}, {label: 'Thursday Market (Carmel)', value: 'thursday'}, {label: 'Saturday Market (Santa Cruz)', value: 'saturday'}, {label: 'Sunday Market (Live Oak)', value: 'sunday'}, ]
    if mode == 'payment'
      shipping_rates = [
        {
          shipping_rate_data: {
